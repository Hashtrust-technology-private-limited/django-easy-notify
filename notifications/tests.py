...
from notifications.utils import send_notification, get_notifications
from notifications.factories import UserFactory, CategoryFactory, NotificationFactory
...
class TestNotification(TestCase):
    def setUp(self) -> None:
        ...
        self.receivers = [UserFactory(username = "ReceiverA"), UserFactory(username = "ReceiverB")]
        self.notification = NotificationFactory.create(title = "First Notification", message = "Hello World")
    ...
    def test_invalid_notification_type(self):
        ...
        assert response == "Please provide valid notification type. It should be one of ['success', 'error', 'warning', 'info']."
